...
//            private packetRules packetrules;
            ...
            private void __nativeAcceptCallback(IAsyncResult r)
            {
                ...
                long uid = globalhandler.onAccept();
                client[uid] = new Client(__temp, uid, this.globalhandler);
            ...
            private void __nativeRecvCallback(IAsyncResult r)
            {
                ...
                try
                {
                    ...
                    if (recvsize > 0)
                    {
                        ...
                        clnt.buffer = new byte[recvsize + bufferlen];
                        
                        clnt.buffer.Concat(clnt.tmpbuffer);
            ...
            private void __onAccept(Socket connectSocket)
            {
                long uid = globalhandler.onAccept();
        ...
        public class GlobalFilter
        {
            ...
            public long onAccept() { return UID.uid; } // must return uid
        ...
        public class Filter
        {
            ...
            public Filter(PacketHandleFunction rule, HeaderVerify condition)
            {
                this.rule = rule;
